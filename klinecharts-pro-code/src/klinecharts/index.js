...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 9.7.2', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
        ...
        if (isValid(defaultFigureStyles)) {
            var cbData = {
                prev: {
                    ...
                    indicatorData: result[dataIndex - 1],
                },
                current: {
                    kLineData: kLineDataList[dataIndex],
                    indicatorData: result[dataIndex],
                },
                next: {
                    kLineData: kLineDataList[dataIndex + 1],
                    indicatorData: result[dataIndex + 1],
...
var IndicatorImp = /** @class */ (function () {
    ...
    IndicatorImp.prototype.setPrecision = function (precision, flag) {
        ...
        if (optimalPrecision !== this.precision &&
            precision >= 0 &&
            (!f || (f && !this._precisionFlag))) {
...
function drawLine(ctx, attrs, styles) {
    ...
    if (length > 1) {
        var _a = styles.style, style = _a === void 0 ? LineType.Solid : _a, smooth = styles.smooth, _b = styles.size, size = _b === void 0 ? 1 : _b, _c = styles.color, color = _c === void 0 ? 'currentColor' : _c, _d = styles.dashedValue, dashedValue = _d === void 0 ? [2, 2] : _d;
        ctx.lineWidth = size;
...
var DEFAULT_REQUEST_ANIMATION_ID = -1;
var Canvas = /** @class */ (function () {
    function Canvas(style, listener) {
        ...
        this._mediaQueryListener = function () {
            ...
            var _a = _this._element.getBoundingClientRect(), width = _a.width, height = _a.height;
            _this._resetPixelRatio(Math.round(width * pixelRatio), Math.round(height * pixelRatio), pixelRatio, pixelRatio);
        };
        ...
        isSupportedDevicePixelContentBox().then(function (result) {
            ...
            if (result) {
                _this._resizeObserver = new ResizeObserver(function (entries) {
                    ...
                    if (isValid((_a = entry === null || entry === void 0 ? void 0 : entry.devicePixelContentBoxSize) === null || _a === void 0 ? void 0 : _a[0])) {
                        var size = (entry.devicePixelContentBoxSize[0]);
                        var width = size.inlineSize;
                        var height = size.blockSize;
                        if (_this._pixelWidth !== width || _this._pixelHeight !== height) {
                            var bounding = _this._element.getBoundingClientRect();
                            _this._resetPixelRatio(width, height, width / bounding.width, height / bounding.height);
                        }
                    }
                });
...
var DrawWidget = /** @class */ (function (_super) {
    ...
    DrawWidget.prototype.updateImp = function (container, bounding, level) {
        ...
        var l = level;
        var _a = container.getBoundingClientRect(), w = _a.width, h = _a.height;
        if (width !== w || height !== h) {
    ...
    CandleBarView.prototype.drawImp = function (ctx) {
        ...
        if (candleBarOptions !== null) {
            ...
            this.eachChildren(function (data, barSpace) {
                ...
                var openY = yAxis_1.convertToPixel(open);
                var closeY = yAxis_1.convertToPixel(close);
                var priceY = [
                    openY, closeY,
...
var IndicatorTooltipView = /** @class */ (function (_super) {
    ...
    function IndicatorTooltipView() {
        ...
        _this._boundIconClickEvent = function (currentIcon, iconId) { return function () {
            ...
            pane.getChart().getChartStore().getActionStore().execute(ActionType.OnTooltipIconClick, __assign(__assign({}, currentIcon), { iconId: iconId }));
            return true;
        }; };
...
var DrawPane = /** @class */ (function (_super) {
    ...
    DrawPane.prototype.setOptions = function (options) {
        ...
        if ((_b = (_a = options.axisOptions) === null || _a === void 0 ? void 0 : _a.scrollZoomEnabled) !== null && _b !== void 0 ? _b : true) {
        ...
        if (topPane !== null &&
            ...
            if (startDragReducedPaneHeight > reducedPaneMinHeight) {
                ...
                chart
                    .getChartStore()
                    .getActionStore()
                    .execute(ActionType.OnPaneDrag, { paneId: currentPane.getId() });
...
var SyntheticEvent = /** @class */ (function () {
        ...
        this._onMobileSafariDoubleClick = function (dblClickEvent) {
            if (_this._firesTouchEvents(dblClickEvent)) {
                ...
                if (_this._tapTimeoutId !== null && _this._tapCount > 1) {
                    ...
                    if (manhattanDistance < 30 /* ManhattanDistance.DoubleTap */ &&
                        !_this._cancelTap) {
                ...
                if (_this._clickTimeoutId !== null && _this._clickCount > 1) {
                    ...
                    if (manhattanDistance < 5 /* ManhattanDistance.DoubleClick */ &&
                        !_this._cancelClick) {
    ...
    SyntheticEvent.prototype._touchMoveHandler = function (moveEvent) {
        ...
        if (!this._touchMoveExceededManhattanDistance &&
            manhattanDistance < 5 /* ManhattanDistance.CancelTap */) {
            return;
        }
        if (!this._touchMoveExceededManhattanDistance) {
            ...
            var isVertDrag = yOffset >= correctedXOffset &&
                !this._options.treatVertDragAsPageScroll();
            var isHorzDrag = correctedXOffset > yOffset &&
                !this._options.treatHorzDragAsPageScroll();
    ...
    SyntheticEvent.prototype._init = function () {
        ...
        this._target.addEventListener("touchcancel", this._clearLongTapTimeout.bind(this));
        {
            ...
            var outsideHandler_1 = function (event) {
                ...
                if (event.composed &&
                    _this._target.contains(event.composedPath()[0])) {
                    return;
                }
                if (event.target !== null &&
                    _this._target.contains(event.target)) {
                    return;
                }
    ...
    SyntheticEvent.prototype._initPinch = function () {
        ...
        this._target.addEventListener("touchmove", function (event) {
            if (event.touches.length !== 2 ||
                _this._startPinchMiddleCoordinate === null) {
                return;
            }
    ...
    SyntheticEvent.prototype._firesTouchEvents = function (e) {
        ...
        return (this._eventTimeStamp(e) <
            this._lastTouchEventTimeStamp + 500 /* Delay.PreventFiresTouchEvents */);
    };
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype._measurePaneHeight = function () {
        var _this = this;
        var _a;
        var h = this._container.getBoundingClientRect().height;
        var totalHeight = Math.floor(h);
    ...
    ChartImp.prototype._measurePaneWidth = function () {
        var _this = this;
        var w = this._container.getBoundingClientRect().width;
        var totalWidth = Math.floor(w);
    ...
    ChartImp.prototype.getCandlePane = function () {
        return this._candlePane;
    };
    ...
    ChartImp.prototype.crosshairChange = function (crosshair) {
        ...
        if (actionStore.has(ActionType.OnCrosshairChange)) {
            ...
            this._drawPanes.forEach(function (pane) {
                ...
                var indicators = _this._chartStore
                    .getIndicatorStore()
                    .getInstances(id);
                indicators.forEach(function (indicator) {
                    var _a;
    ...
    ChartImp.prototype.getSize = function (paneId, position) {
        ...
        if (isValid(paneId)) {
            ...
            var _c = this._chartContainer.getBoundingClientRect(), width = _c.width, height = _c.height;
            return {
    ...
    ChartImp.prototype.getConvertPictureUrl = function (includeOverlay, type, backgroundColor) {
        var _this = this;
        var _a = this._chartContainer.getBoundingClientRect(), width = _a.width, height = _a.height;
        var canvas = createDom("canvas", {
            width: "".concat(width, "px"),
            height: "".concat(height, "px"),
            boxSizing: "border-box",
